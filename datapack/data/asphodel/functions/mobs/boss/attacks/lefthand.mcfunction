...
execute at @s[tag=!AM.Drop] run tp @s ^ ^ ^.4
...
execute at @s[tag=AM.Drop] unless block ~ ~4 ~ #asphodel:cloud run function asphodel:mobs/boss/attacks/hit_floor
